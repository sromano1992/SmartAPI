...
public class NuovoAmministratore extends JFrame {
	...
	public NuovoAmministratore(SmartAPIModel model) {
		this.model = model;
		setSize(395, 555);
		setVisible(true);
	...
	private void initComponents() {
        	...
        	public void actionPerformed(ActionEvent arg0) {
        		try {
        			...
        			if(Arrays.toString(confermaPassword).equals(Arrays.toString(password))) {
        				...
        				if(model.addUser(nome, cognome, email, username, realPassword.toString(), true)) {
        ...
        JLabel lblNewLabel_1 = new JLabel("E' la prima volta che si entra nel sistema.");
        lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 14));
        
        JLabel lblNewLabel_2 = new JLabel("Inserire un amministratore.");
